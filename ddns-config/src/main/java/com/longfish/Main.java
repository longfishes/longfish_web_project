...
public class Main {
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException, InvalidKeyException {
        String secretId = ConfigReader.getSecretId();
        String secretKey = ConfigReader.getSecretKey();
        String token = "";
        String version = "2021-03-23";
        String action = "CreateRecord";
        String body = "{\"Domain\":\"longfish.site\",\"RecordType\":\"AAAA\",\"RecordLine\":\"默认\",\"Value\":\"::1\",\"SubDomain\":\"test\"}";
        String region = "";
