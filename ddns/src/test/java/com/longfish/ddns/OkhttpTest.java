...
public class OkhttpTest {
    ...
    public void test() throws IOException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        Map response = JSONObject.toJavaObject(json, Map.class);
        RecordListResp recordListResp = JSONObject.toJavaObject((JSON) response.get("Response"), RecordListResp.class);

        System.out.println(recordListResp);
    }
